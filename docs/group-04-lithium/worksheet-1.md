...
|             Feature             |                                        Purpose                                      |
| ------------------------------- | ----------------------------------------------------------------------------------- |
|                                 | Dormers will be able to select the food and drink/s they wish to consume digitally. |
| 1. Digital Food & Beverage Menu | This allows them to order their food from anywhere and doesn’t need them to line up |
|                                 | in the canteen, making it more convenient especially for tired dormers.             |
|                                 | Dormers will be able to pay for their meals through digital methods (e.g. GCash)    |
| 2. Digital Payment Methods      | and can just send the digital receipt to the site for confirmation. This helps      |
|                                 | dormers who have more access to digital money than physical and allows for more     |
|                                 | convenient payments.                                                                |
|                                 | The canteen will then click on a confirmation button from their side of the site to |
| 3. Canteen Confirmation Button  | process a dormer’s order. Once the order has been processed, it will become visible |
|                                 | on the dormer’s side of the site. This confirms with the dormer that their order is |
|                                 | actually being made.                                                                |
| 4. Dorm Delivery                | The order will be delivered to the dorm lobby, where the dormers can just pick it   |  
|                                 | up. This way, the dormers can easily claim their food faster.                       |
